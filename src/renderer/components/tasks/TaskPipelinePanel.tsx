...
const STAGES: { id: PipelineStage; label: string; activeColor: string; mutedColor: string; selectedBg: string }[] = [
  ...
  { id: 4, label: '编码实现', activeColor: 'text-orange-600',  mutedColor: 'text-orange-400/30',  selectedBg: 'bg-orange-500/15'  },
  { id: 5, label: '验证收尾', activeColor: 'text-pink-600',    mutedColor: 'text-pink-400/30',    selectedBg: 'bg-pink-500/15'    },
]
