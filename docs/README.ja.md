...
### AI デジタルヒューマンシステム
スケジュールまたはイベントに応じて自律的に動作する AI エージェント（デジタルヒューマン）を作成・管理 — 監視、報告、通知、すべてバックグラウンドで。
...
*AI ストア：数秒でデジタルヒューマンを検索・インストール*

![AI Store](./assets/shop.png)

*AI デジタルヒューマン：バックグラウンドで自律的に動作するエージェント*
...
- [x] AI プラグインアプリストア
- [ ] サードパーティエコシステムプラグインの互換性
- [ ] コード編集体験の強化（VS Code などの外部エディタへの依存を軽減）
