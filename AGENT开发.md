...
## 1. 需求与能力定义
- 明确 Agent 任务边界：需求识别、任务拆解、开发计划、编码实现、用例验证
- 确定能力范围：
...
2. **记忆模块**
- 短期记忆：对话上下文
- 长期记忆：向量库/知识库存储经验、文档、历史
3. **工具执行层**
函数调用、代码解释器、插件系统、外部 API
...
- 固定流程
- LLM 自主规划
- 图执行引擎（Graph/State Machine）
- 多 Agent 协作（Leader-Worker 模式）
